...
Compiler Options:-
         ...
         {green small}             {yellow Compiles smaller file}      {red encryptor compile <file> --small}
         ...
         if (args["bin"][0] === "compile") 
         {
                  ...
                  try {
                           ...
                           try {
                                    ...
                                    config.fast = JSON.parse(readFileSync(`${process.cwd()}/encryptor.config.json`))?.small;
                           } catch(e) {

                           }

                           config.file = args["bin"][1];
                           if (typeof(args.small) === "boolean") {
                                    config.fast = args["small"];
                           }
                           if (args["outDir"]) {
         ...
         (args["bin"][0] == "init") 
         {
                  ...
                  .prompt([
                           ...
                           },
                           {
                                    type: "confirm",
                                    name: "small",
                                    message: chalk.yellow("Small Size Compile? (Leads to higher security risks)"),
                                    default: false
                           }
                  ]);
